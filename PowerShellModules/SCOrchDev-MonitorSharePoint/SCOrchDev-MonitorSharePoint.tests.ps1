...
$manifestPath = "$here\SCOrchDev-MonitorSharePoint.psd1"
Import-Module SCOrchDev-MonitorSharePoint -Force

Describe -Tags 'VersionChecks' 'SCOrchDev-MonitorSharePoint manifest' {
    ...
    It 'has a valid name in the manifest' {
        $script:manifest.Name | Should Be SCOrchDev-MonitorSharePoint
    }
...
Describe 'Style rules' {
    $SCOrchDevUtilityRoot = (Get-Module SCOrchDev-SQL).ModuleBase
